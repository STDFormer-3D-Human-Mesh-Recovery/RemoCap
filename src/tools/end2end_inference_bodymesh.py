...
import cv2
import sys 
sys.path.append("/HOME/Zhongzhangnan/FastMETRO")
...
def parse_args():
    ...
    #########################################################
    parser.add_argument("--image_file_or_path", default='/HOME/Zhongzhangnan/FastMETRO/demo/Humans-Body', type=str, 
                        help="test data")
    #########################################################
    ...
    parser.add_argument("--resume_checkpoint", default="/HOME/Zhongzhangnan/FastMETRO/models/fastmetro_checkpoint/FastMETRO-L-H64_smpl_3dpw_state_dict.bin", type=str, required=False,
